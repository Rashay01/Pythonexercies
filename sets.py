...
print(outdoor_activities.union(
    indoor_activties))  # return a set with cycling once
...
new_outdoor_activities1 = {
    key
    for key, value in activity_gadgets.items() if value in outdoor_activities
}
...
new_outdoor_gadgets2 = set([
    key for key, value in activity_gadgets.items()
    if value in outdoor_activities
])
...
def get_activity_gadgets(activity_gadgets, activity_list):
  return set([
      gadget for gadget, activity in activity_gadgets.items()
